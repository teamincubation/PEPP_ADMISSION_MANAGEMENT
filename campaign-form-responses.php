...
if (!has_form_access($pdo, $admin_username, $form_id)) {
    die("<div style='padding:2rem; font-family:sans-serif; text-align:center; color:#ef4444;'><h2>Access Denied</h2><p>You do not have permission to view responses for this form.</p></div>");
}
